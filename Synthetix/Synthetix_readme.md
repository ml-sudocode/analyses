...
Original model in Excel: [relative link to XLSX file]

Google sheet version. This was a simple Excel-Gsheets conversion, provided for convenience, and has not been checked for discrepancies that sometimes happen in conversions.
